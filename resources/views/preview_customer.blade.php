...
<div style="width: 65%;">
	<div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="nav-item">
                <a href="#tab_orders" aria-controls="tab_orders" role="tab" tab_name="orders" data-toggle="tab" class="nav-link" aria-selected="false">
                    Order histories
                </a>
            </li>
        </ul>
        ...
        <div class="bg-white pt-1 pb-2" style="border-left: 1px solid #d9e2ef;
            ...
            <div role="tabpanel" class="tab-pane px-3 py-2" id="tab_orders" style="width: 100%;">
                @if (count($orders) > 0)
                    <table style="width: 100%; white-space: nowrap;">
                        ...
                        <tbody>
                            @foreach ($orders as $item)
                                <tr>
                                    <td class="py-2">{{ $item->getSeller()->name }}</td>
